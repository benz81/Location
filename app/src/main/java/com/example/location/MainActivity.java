...
public class MainActivity extends AppCompatActivity {
    ...
    private String clientId = "bts0v74u1b";
    private String clientSecret = "YYyHZ0s8YYG9GdFFHfV5nwf9sGSWaDoXJBuEo7uD";

    private String baseUrl = "https://naveropenapi.apigw.ntruss.com/map-static/v2/raster?w=1024&h=1024&level=16";
